...
var usersResource = schema.GroupVersionResource{Group: "containership.io", Version: "v3", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "containership.io", Version: "v3", Kind: "User"}

// Get takes name of the user, and returns the corresponding user object, and an error if there is any.
func (c *FakeUsers) Get(name string, options v1.GetOptions) (result *v3.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(usersResource, c.ns, name), &v3.User{})
...
func (c *FakeUsers) List(opts v1.ListOptions) (result *v3.UserList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(usersResource, usersKind, c.ns, opts), &v3.UserList{})
...
func (c *FakeUsers) Create(user *v3.User) (result *v3.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(usersResource, c.ns, user), &v3.User{})
...
func (c *FakeUsers) Update(user *v3.User) (result *v3.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(usersResource, c.ns, user), &v3.User{})
...
func (c *FakeUsers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(usersResource, c.ns, name), &v3.User{})
