...
func newPlugins(c *ContainershipV3Client, namespace string) *plugins {
	return &plugins{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *plugins) Get(name string, options v1.GetOptions) (result *v3.Plugin, err error) {
	result = &v3.Plugin{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("plugins").
...
func (c *plugins) List(opts v1.ListOptions) (result *v3.PluginList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v3.PluginList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("plugins").
...
func (c *plugins) Create(plugin *v3.Plugin) (result *v3.Plugin, err error) {
	result = &v3.Plugin{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("plugins").
...
func (c *plugins) Update(plugin *v3.Plugin) (result *v3.Plugin, err error) {
	result = &v3.Plugin{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plugins").
...
func (c *plugins) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3.Plugin, err error) {
	result = &v3.Plugin{}
