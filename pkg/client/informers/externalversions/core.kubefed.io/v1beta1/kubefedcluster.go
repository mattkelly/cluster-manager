...
import (
	...
	corekubefediov1beta1 "github.com/containership/cluster-manager/pkg/apis/core.kubefed.io/v1beta1"
	...
	v1beta1 "github.com/containership/cluster-manager/pkg/client/listers/core.kubefed.io/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeFedCoreV1beta1().KubeFedClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeFedCoreV1beta1().KubeFedClusters(namespace).Watch(options)
			},
		},
		&corekubefediov1beta1.KubeFedCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubeFedClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corekubefediov1beta1.KubeFedCluster{}, f.defaultInformer)
}
