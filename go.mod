module github.com/containership/cluster-manager

go 1.12

require (
	github.com/aws/aws-sdk-go v1.15.79
	github.com/containership/cerebral v0.3.0-alpha
	github.com/containership/csctl v0.0.0-20190409165802-b814eaf3118f
